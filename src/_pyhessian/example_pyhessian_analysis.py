...
parser.add_argument(
    "--mini-hessian-batch-size", type=int, default=200, help="input batch size for mini-hessian batch (default: 200)"
)
...
# get dataset
train_loader, test_loader = getData(name="cifar10_without_dataaugmentation", train_bs=args.mini_hessian_batch_size, test_bs=1)
##############
...
if batch_num == 1:
    ...
    hessian_comp = hessian(model, criterion, dataloader=hessian_dataloader, cuda=args.cuda)
