# Overview
- This module is copy pasted from https://github.com/marcellodebernardi/loss-landscapes/tree/master, for bug fixing and flex adaptations.
- The original implementation doesn't work out of box on flexible layers.
